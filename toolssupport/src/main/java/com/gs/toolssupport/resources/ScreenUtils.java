...
public class ScreenUtils {
    ...
    public static int getScreenWidth() {
        WindowManager manager = (WindowManager) GlobalInit.application
    ...
    public static int getActionBarHeight(Context context) {
        ...
        if (context instanceof AppCompatActivity && ((AppCompatActivity) context)
            ...
            } else if (((ActivityGroup) context).getCurrentActivity() != null &&
                    ((ActivityGroup) context).getCurrentActivity().getActionBar() !=
                            null) {
                actionBarHeight = ((ActivityGroup) context).getCurrentActivity()
